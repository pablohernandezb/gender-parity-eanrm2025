...
def get_circunscriptions_by_state(circunscription_json_file: str, party_position_json_file: str, target_election_type: int = 24) -> Dict[int, List[Dict[str, any]]]:
    """
    ...
    Args:
        ...
        target_election_type (int, optional): The election type to filter by. Defaults to 24.
